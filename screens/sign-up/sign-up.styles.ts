...
export const GhostElement = styled.View`
  width: 100%;
  height: 50px;
...
export const SingnInText = styled.Text`
  font-size: 14px;
  font-weight: normal;
  color: #262626;
...
export const SingnInButton = styled.TouchableOpacity`
  border: none;
  background-color: transparent;
  margin-left: 5px;
`
export const SingnInButtonText = styled.Text`
  font-size: 14px;
  font-weight: normal;
  color: #4AD196;
